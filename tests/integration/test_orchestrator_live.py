"""Integration tests for StockAnalyzerOrchestrator (live tests with real Azure services)."""
...
@pytest.mark.live
@pytest.mark.asyncio
async def test_orchestrator_delegates_to_stock_agent():
...
@pytest.mark.live
@pytest.mark.asyncio
async def test_orchestrator_returns_valid_stock_format():
